            ...
            <div className="relative min-h-screen">
                <div 
                    ...
                    style={{
                        ...
                        opacity: '0.8' // Ajustez cette valeur selon vos besoins
                    }}
                    aria-hidden="true"
                />
                ...
                <div className={`contact-form-section ${showOnlyForm ? '' : 'min-h-screen'} mt-12`}>
                    ...
                    >
                        {({ isSubmitting }) => (
                            <div className={`${showOnlyForm ? '' : 'min-h-screen'} flex items-center justify-center px-4`}>
                                <div className="Form w-full max-w-2xl bg-white/50 backdrop-blur-sm rounded-2xl shadow-xl p-8 mx-auto">
