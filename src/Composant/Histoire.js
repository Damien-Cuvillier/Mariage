  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-8">
      <div 
        ...
        aria-hidden="true"
      />
      <h2 className="text-2xl sm:text-3xl font-bold text-white text-center mb-8 sm:mb-16">Notre Histoire</h2>

      <div className="max-w-4xl mx-auto space-y-8 sm:space-y-16">
        {/* Premier paragraphe avec image */}
        <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-8">
          <div className="w-full md:w-1/2">
            <p className="text-sm sm:text-base text-black leading-relaxed mb-6 md:mb-0">
        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-6 sm:gap-8">
          <div className="w-full md:w-1/2">
            <p className="text-sm sm:text-base text-black leading-relaxed mb-6 md:mb-0">
              ...
              lui restant à Tours. Mais parfois, les plus belles histoires naissent des situations 
